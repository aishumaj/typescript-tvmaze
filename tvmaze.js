...
var API_BASE_URL = "http://api.tvmaze.com";
var MISSING_IMAGE = "https://tinyurl.com/tv-missing";
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var searchResponse, listOfShows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(API_BASE_URL, "/search/shows?q=").concat(term))];
                case 1:
                    searchResponse = _a.sent();
                    listOfShows = searchResponse.data.map(function (elem) {
                        var _a;
                        return {
                            id: elem.show.id,
                            name: elem.show.name,
                            summary: elem.show.summary,
                            image: ((_a = elem.show.image) === null || _a === void 0 ? void 0 : _a.medium) || MISSING_IMAGE
                        };
                    });
                    return [2 /*return*/, listOfShows];
            }
        });
    });
}
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var episodeListResponse, episodeList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(API_BASE_URL, "/shows/").concat(id, "/episodes"))];
                case 1:
                    episodeListResponse = _a.sent();
                    episodeList = episodeListResponse.data.map(function (elem) {
                        return {
                            id: elem.id,
                            name: elem.name,
                            season: elem.season,
...
function populateEpisodes(episodes) {
    ...
    for (var _i = 0, episodes_1 = episodes; _i < episodes_1.length; _i++) {
        ...
        var $ep = $("<li>".concat(ep.name, " (season ").concat(ep.season, ", episode ").concat(ep.number, ")</li>"));
 ...
 */
function getEpisodeListAndDisplay(evt) {
    return __awaiter(this, void 0, void 0, function () {
        var id, episodes;
        return __generator(this, function (_a) {
            switch (_a.label) {
